...
$(document).ready(function(){
    var postListImage = $('.bsl-l-image');

    postListImage.mouseover(function(){
        $(this).find('.bsl-fader').addClass('seventypercentheight');
    });
    postListImage.mouseout(function(){
        $(this).find('.bsl-fader').removeClass('seventypercentheight');
    });
});
